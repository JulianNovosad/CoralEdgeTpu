...
# Verify calculations from our data with correct formula
test_cases = [
    ...
    {"width_px": 99.5, "reported_dist": 2.203},
    {"width_px": 61.9, "reported_dist": 2.203},
    {"width_px": 56.5, "reported_dist": 2.304},
]

print("\nDetailed verification of distance calculations:")
...
print(f"\nThe discrepancies are due to the smoothing algorithm which takes the median")
print(f"of a rolling window of distance estimates, not the raw instantaneous values.")